...
import { LogInComponent } from 'src/app/popup/log-in/log-in.component';
              ...
              .subscribe({
                next: (res: any) => {
                  if (res._id) {
                    ...
                    this.matdialog.open(LogInComponent, { width: '40%', height: '80%' })
                    this.snackbar.open('Registered Successfully', 'Ok', { duration: 1000 })
